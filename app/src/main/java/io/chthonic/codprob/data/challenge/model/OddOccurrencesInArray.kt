...
class OddOccurrencesInArray(override val index: Int) : Challenge<IntArray, Int> {

    override val name: String = "OddOccurrencesInArray"
    ...
    override val samples: List<ChallengeSample<IntArray, Int>> by lazy {
        listOf(
            OddOccurrencesInArraySample(intArrayOf(9, 3, 9, 3, 9, 7, 9), 7)
        )
    }
...
class OddOccurrencesInArraySample(override val input: IntArray, override val output: Int) : ChallengeSample<IntArray, Int>